  ...
  const medicalItems = [
    {
      ...
      description: "Tıbbi malzeme ambalajlama için steril ve güvenilir kağıt çözümleri. Hastane standartlarına uygun hijyenik ambalajlama."
    },
    {
      name: "MUKAVVA KUTU",
      count: "Firma Özel Tasarım",
      image: "/restaurant_cafe_hotel/11mukavva.png",
      description: "Tıbbi malzeme depolaması için dayanıklı mukavva kutular. Eczane ve hastane stoklarında güvenilir saklama çözümü."
    },
    {
      name: "ÜRÜN AMBALAJI",
      count: "Firma Özel Tasarım",
      image: "/restaurant_cafe_hotel/14ürünambalaj.png",
      description: "Tıbbi ürünler için özel tasarım ambalajlar. İlaç ve tıbbi cihaz ambalajlaması için sterilizasyon uyumlu çözümler."
    },
    {
      name: "TEMİZLİK ÜRÜNLERİ",
      count: "Firma Özel Tasarım",
      image: "/restaurant_cafe_hotel/15temizlikürün.png",
      description: "Hastane standartında dezenfektan ve temizlik ürünleri. Tıbbi ortamlar için antibakteriyel ve antiviral özellikli temizlik çözümleri."
    }
  ];
